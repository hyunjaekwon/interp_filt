...
if {[file exists "floorplan_user.tcl"]} {
  echo "Using user floorplan"
  source -echo floorplan_user.tcl
} else {
  echo "Using basic floorplan"
  create_floorplan \
...
insert_stdcell_filler   \
        -cell_without_metal "SHFILL128_LVT SHFILL64_LVT SHFILL3_LVT SHFILL2_LVT SHFILL1_LVT" \
